...
describe 'Admin can uncomplete game', type: :feature do
  ...
  let!(:player_1) { create(:player, game: game, finishing_order: 1, additional_expense: 0, finishing_place: 2, score: 1.825) }
  let!(:player_2) { create(:player, game: game, finishing_order: 2, additional_expense: 1, finishing_place: 1, score: 2.645) }
